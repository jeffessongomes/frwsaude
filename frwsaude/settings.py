"""
Django settings for frwsaude project.
...
SECRET_KEY = '##$*u6br@gb)map_365lw)e%h)3n6!13y(s0#d1ly8@a#+y-q!'
...
WSGI_APPLICATION = 'frwsaude.wsgi.application'
